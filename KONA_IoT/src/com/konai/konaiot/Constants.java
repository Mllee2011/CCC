...
public class Constants {
    ...
    public static final short OFF_OBJECT_SIZE = (short) OFF_SM_DATA+LEN_SM_STATE;
    public static final short LEN_OBJECT_SIZE = (short)2;
    
    public static final short OFF_OFF_RESPONSE_START = (short) OFF_OBJECT_SIZE+LEN_OBJECT_SIZE;
